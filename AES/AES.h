...
namespace AES
{
	...
	const std::vector<int> RCON_BOX = 
	{
		{0x00, 0x01, 0x02, 0x04, 0x08, 0x10, 0x20, 0x40, 0x80, 0x1b, 0x36} 
	};

	const std::vector<std::vector<int>> L_TABLE =
	{
	...
	const std::vector<std::vector<int>> E_TABLE = 
	{
	...
	const std::vector<std::vector<int>> INV_S_BOX = 
	{
	...
	const std::vector<std::vector<int>> MIX_COL_MATRIX = 
	{
		{2, 3, 1, 1},
		{1, 2, 3, 1},
		{1, 1, 2, 3},
	...
	const std::vector<std::vector<int>> INV_MIX_COL_MATRIX = 
	{
		{0x0E, 0x0B, 0x0D, 0x09},
		{0x09, 0x0E, 0x0B, 0x0D},
		{0x0D, 0x09, 0x0E, 0x0B},
