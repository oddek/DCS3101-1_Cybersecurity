...
The most essence of the code lies in these two functions. We loop through the plaintext, while keeping another int to keep track of where in the keyword we are. We shift the currenct character in the plaintext by the relative value of the current letter in the keyword. 
